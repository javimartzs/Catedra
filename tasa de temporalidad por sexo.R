...
contrato <- read.px("../../../Downloads/4241-2.px")%>% as_tibble()

#CONVIERTO LOS NOMBRES EN CARACTERES PARA PODER AÑADIR EL CODIGO 00 AL TOTAL NACIONAL PARA QUE AL SEPARARLOS SE ME SEPARE BIEN
...
#CREAMOS EL DF GRAFICO Y LO FILTRO POR CONTRATO TEMPORAL, TOTAL NACIONAL A PARTIR DEL CODAUTO QUE AÑADIMOS ANTES
#TERCER TRIMESTRE, PERIODO A PARTIR DEL CUAL EMPIEZA EL GRAFICO Y ELIMINAMOS AMBOS SEXOS PARA QUE SOLO NOS PINTE "HOMBRE Y MUJER"
